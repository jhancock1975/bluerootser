...
<h1>Character Memorization Techniques</h1>
<ul>
	<li>Imagine the character being written a stroke at a time. Once you can see it being written in your mind correctly
	move on.
	<li>Many characters derive their sound from other characters.  Sometimes one character contains another character,
	...
	One of the meanings of 是 is, "to be."  Knowing all this, how could one forget the meaning, or pronunciation of 是?<li>
	<li>Related to the previous technique, make a note of the radicals the character is composed of.  Characters are
	combinations of radicals.  It is easier for some to remember a list of three or four radicals, rather than a list
	of 10 or 20 strokes.
	<li>Dump a bucket of ice-water on your head every time you forget a character.  Just kidding!  Hundreds of millions, 
	...
	break, or move on to the next one.  That particularly annoying character will still be there tomorrow.   
</ul>  
